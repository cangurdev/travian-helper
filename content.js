      ...
      div.innerHTML = `
                  <div class='content sidebarBoxWrapper' id="openButtonContainer" style="display: flex; flex-direction: column; align-items: center;">
                    ...
                    <div class="buttonsWrapper">
                      ...
                      <a class="layoutButton buttonFramed withIcon round stable gold" href="build.php?gid=20">
                      ...
                      <a class="layoutButton buttonFramed withIcon round workshop gold" href="build.php?gid=21">
